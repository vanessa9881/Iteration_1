...
public class TileComparator implements Comparator<Tile>{
	...
	public int compare(Tile t1, Tile t2) {
		...
		if (t1.getValue() > t2.getValue()) {return 1;}
		...
		else { // Tiles have the same value so compare colours
			...
			else if(t2.getColour().toString().equals("Red")) {return 1;}
			
			else if(t1.getColour().toString().equals("Yellow")) {return 1;}
			else if(t2.getColour().toString().equals("Yellow")) {return -1;}
